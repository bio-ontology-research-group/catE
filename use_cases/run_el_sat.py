...
import click as ck
import os
from src.el_sem_sat import ELModel
...
@ck.option('--model_type', '-model', required=True, type=ck.Choice(["elem", "elbe"]))
...
def main(use_case, model_type, num_models, emb_dim, batch_size,
         lr, num_negs, test_batch_size, epochs, device, seed,
    ...
    model_filepath = os.path.join(models_dir, f"{use_case}_{model_type}_{emb_dim}_{batch_size}.pt")
