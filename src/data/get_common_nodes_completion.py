"""Projection methods such as RDF and Onto2Graph consider synonym classes.
Testing against other methods that do not use sysnonym classes might not be fair.
Therefore, in this script, we will remove the synonym classes 
"""
